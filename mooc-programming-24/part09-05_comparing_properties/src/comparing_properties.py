...
class RealProperty:
    ...
    def price_difference(self, compared_to: "RealProperty"):
        total_price = self.price_per_sqm * self.square_metres
        compared_to_total_price = compared_to.price_per_sqm * compared_to.square_metres
        difference = total_price - compared_to_total_price
        return (difference * (-1)) if difference < 0 else difference

    def more_expensive(self, compared_to: "RealProperty"):
        return self.price_per_sqm * self.square_metres > compared_to.square_metres * compared_to.price_per_sqm
